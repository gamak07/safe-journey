  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white px-6 py-4 shadow-sm">
      <div className="flex w-full items-center justify-between overflow-hidden">
        ...
        <Button className="flex cursor-pointer items-center rounded-md bg-blue-600 px-4 py-2 font-medium whitespace-nowrap text-white transition-colors hover:bg-blue-700" onClick={() => router.push('/overview')}>
